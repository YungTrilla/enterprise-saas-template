...
function isDateInRange(date, startDate, endDate) {
    ...
    if (!d || !start || !end)
        return false;
    return ((0, date_fns_1.isAfter)(d, start) || (0, date_fns_1.isSameDay)(d, start)) &&
