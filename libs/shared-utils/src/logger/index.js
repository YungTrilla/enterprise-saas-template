...
exports.logDebug = exports.logInfo = exports.logWarn = exports.logError = exports.defaultLogger = exports.StructuredLogger = void 0;
...
function createLogger(config = {}) {
    ...
    // Define log format
    const logFormat = winston_1.default.format.combine(winston_1.default.format.timestamp(), winston_1.default.format.errors({ stack: true }), finalConfig.enableJsonFormat
